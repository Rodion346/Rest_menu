...
class TestMenu:
    ...
    def test_create_menu(self, client: TestClient, menu_data: dict) -> None:
        response_create = client.post(reverse_operation(client, "create_menu"), json=menu_data)
    ...
    def test_read_menu(self, client: TestClient, create_menu: Menu) -> None:
        response_read = client.get(reverse_operation(client, "read_menu", menu_id=create_menu.id))
    ...
    def test_update_menu(self, client: TestClient, create_menu: Menu) -> None:
        ...
        response_update = client.patch(
            reverse_operation(client, "update_menu", menu_id=create_menu.id),
            json=updated_data
        )
    ...
    def test_delete_menu(self, client: TestClient, create_menu: Menu) -> None:
        response_delete = client.delete(reverse_operation(client, "delete_menu", menu_id=create_menu.id))
