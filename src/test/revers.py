def reverse_operation(route_name: str, **kwargs) -> str:
    routes = {
        ...
        'read_dish': f"/api/v1/menus/{kwargs.get('menu_id', '')}/submenus/{kwargs.get('submenu_id', '')}/dishes/{kwargs.get('dish_id', '')}",
        'update_dish': f"/api/v1/menus/{kwargs.get('menu_id', '')}/submenus/{kwargs.get('submenu_id', '')}/dishes/{kwargs.get('dish_id', '')}",
        'delete_dish': f"/api/v1/menus/{kwargs.get('menu_id', '')}/submenus/{kwargs.get('submenu_id', '')}/dishes/{kwargs.get('dish_id', '')}",
    }
