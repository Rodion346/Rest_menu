...
class TestSubMenu:
    ...
    def test_read_submenus(self, client, create_menu):
    ...
    def test_create_submenu(self, client, submenu_data, create_menu):
    ...
    def test_update_submenu(self, client, create_submenu):
    ...
    def test_delete_submenu(self, client, create_submenu):
